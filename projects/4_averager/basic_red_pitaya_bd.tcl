...
# slice LEDs
#startgroup
#create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xls_LEDs
...
# slice CE
#startgroup
#create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xls_CE
#set_property -dict [list CONFIG.DIN_TO {0} CONFIG.DIN_FROM {0} CONFIG.DIN_WITDH {32} CONFIG.DOUT_WIDTH {1}] [get_bd_cells xls_CE]
#endgroup

# slice SCLR
#startgroup
#create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xls_SCLR
