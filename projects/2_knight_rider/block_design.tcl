...
# Add two rtl modules - reverse_bits
create_bd_cell -type module -reference reverse_bits reverse_bits_0
...
connect_bd_net [get_bd_pins reverse_bits_0/out_bits] [get_bd_pins util_vector_logic_0/Op2]
connect_bd_net [get_bd_pins knight_rider_1/led_out] [get_bd_pins reverse_bits_0/in_bits]
